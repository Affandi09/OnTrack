...
class Imap
{
    ...
    protected function formatMessage($id, $withbody = true)
    {
        ...
        $importance = "Normal";
        if (strpos($fullheader, 'X-Priority: 1') !== false) {
            $importance = "High";
        }
        if (strpos($fullheader, 'X-Priority: 2') !== false) {
            $importance = "High";
        }
        if (strpos($fullheader, 'X-Priority: 4') !== false) {
            $importance = "Low";
        }
        if (strpos($fullheader, 'X-Priority: 5') !== false) {
            $importance = "Low";
        }
