...
switch ($_POST['action']) {
	...
	case "addAsset":
		...
		$status = Asset::add($_POST);
		break;

	case "editAsset":
		isAuthorized("editAsset");
		$status = Asset::edit($_POST);
		break;

	case "deleteAsset":
		isAuthorized("deleteAsset");
		$status = Asset::delete($_POST['id']);
		break;


	// projects
	case "addProject":
		isAuthorized("addProject");
		$status = Project::add($_POST);
		break;

	case "editProject":
		isAuthorized("editProject");
		$status = Project::edit($_POST);
		break;

	case "deleteProject":
		isAuthorized("deleteProject");
		$status = Project::delete($_POST['id']);
		break;

	case "addProjectAdmin":
		isAuthorized("adminsProject");
		$status = Project::assignStaff($_POST);
		break;

	case "deleteProjectAdmin":
		isAuthorized("adminsProject");
		$status = Project::unassignStaff($_POST['id']);
		break;

	case "saveProjectNotes":
		isAuthorized("manageProjectNotes");
		$status = Project::saveNotes($_POST);
		break;

	// project Milestones
	case "addMilestone":
		isAuthorized("addMilestone");
		$status = Milestone::add($_POST);
		break;

	case "editMilestone":
		isAuthorized("editMilestone");
		$status = Milestone::edit($_POST);
		break;

	case "deleteMilestone":
		isAuthorized("deleteMilestone");
		$status = Milestone::delete($_POST['id']);
		break;

	case "releaseMilestone":
		isAuthorized("releaseMilestone");
		$status = Milestone::release($_POST);
		break;
	...
	case "addComment":
		...
		$status = Comment::add($_POST);
		break;

	case "editComment":
		isAuthorized("editComment");
		$status = Comment::edit($_POST);
		break;

	case "deleteComment":
		isAuthorized("deleteComment");
		$status = Comment::delete($_POST['id']);
		break;


	// tickets
	case "addTicket":
		isAuthorized("addTicket");
		$status = Ticket::add($_POST);
		break;
	...
	case "editTicket":
		isAuthorized("editTicket");
		$status = Ticket::edit($_POST);
		break;

	case "deleteTicket":
		isAuthorized("deleteTicket");
		$status = Ticket::delete($_POST['id']);
		break;

	case "updateTicketNotes":
		isAuthorized("manageTicketNotes");
		$status = Ticket::updateNotes($_POST);
		break;
	...
	// credentials
	case "addCredential":
		isAuthorized("addCredential");
		$status = Credential::add($_POST);
		break;

	case "editCredential":
		isAuthorized("editCredential");
		$status = Credential::edit($_POST);
		break;

	case "deleteCredential":
		isAuthorized("deleteCredential");
		$status = Credential::delete($_POST['id']);
		break;
	...
	case "addLicense":
		...
		$status = License::add($_POST);
		break;

	case "editLicense":
		isAuthorized("editLicense");
		$status = License::edit($_POST);
		break;

	case "deleteLicense":
		isAuthorized("deleteLicense");
		$status = License::delete($_POST['id']);
		break;

	case "addLicenseAssignment":
		isAuthorized("assetLicense");
		$status = License::assignAsset($_POST);
		break;

	case "deleteLicenseAssignment":
		isAuthorized("assetLicense");
		$status = License::unassignAsset($_POST['id']);
		break;
	...
	// monitoring
	case "addHost":
		isAuthorized("addHost");
		$status = Monitoring::addHost($_POST);
		break;

	case "editHost":
		isAuthorized("editHost");
		$status = Monitoring::editHost($_POST);
		break;

	case "deleteHost":
		isAuthorized("deleteHost");
		$status = Monitoring::deleteHost($_POST['id']);
		break;

	case "addCheck":
		isAuthorized("manageHost");
		$status = Monitoring::addCheck($_POST);
		break;

	case "editCheck":
		isAuthorized("manageHost");
		$status = Monitoring::editCheck($_POST);
		break;

	case "deleteCheck":
		isAuthorized("manageHost");
		$status = Monitoring::deleteCheck($_POST['id']);
		break;

	case "addHostPeople":
		isAuthorized("manageHost");
		$status = Monitoring::addHostPeople($_POST);
		break;

	case "deleteHostPeople":
		isAuthorized("manageHost");
		$status = Monitoring::deleteHostPeople($_POST['id']);
		break;
	...
	case "addAssetCategory":
		...
		$status = Attribute::addAssetCategory($_POST);
		break;

	case "editAssetCategory":
		isAuthorized("manageData");
		$status = Attribute::editAssetCategory($_POST);
		break;

	case "deleteAssetCategory":
		isAuthorized("manageData");
		$status = Attribute::deleteAssetCategory($_POST['id']);
		break;
	...
	case "addLicenseCategory":
		isAuthorized("manageData");
		$status = Attribute::addLicenseCategory($_POST);
		break;

	case "editLicenseCategory":
		isAuthorized("manageData");
		$status = Attribute::editLicenseCategory($_POST);
		break;

	case "deleteLicenseCategory":
		isAuthorized("manageData");
		$status = Attribute::deleteLicenseCategory($_POST['id']);
		break;
	...
	case "generateQrcodes":
		isAuthorized("manageData");
		$status = Attribute::generateQrcodes($_POST);
		break;

	case "editQrcode":
		isAuthorized("manageData");
		$status = Attribute::editQrcode($_POST);
		break;

	case "deleteQrcode":
		isAuthorized("manageData");
		$status = Attribute::deleteQrcode($_POST['id']);
		break;

	case "deleteBatch":
		isAuthorized("manageData");
		$status = Attribute::deleteBatch($_POST['id']);
		break;

	case "attachQrcode":
		isAuthorized("manageData");
		$status = Attribute::attachQrcode($_POST);
		break;

	case "detachQrcode":
		isAuthorized("manageData");
		$status = Attribute::detachQrcode($_POST['id']);
		break;
	...
	case "addManufacturer":
		isAuthorized("manageData");
		$status = Attribute::addManufacturer($_POST);
		break;

	case "editManufacturer":
		isAuthorized("manageData");
		$status = Attribute::editManufacturer($_POST);
		break;

	case "deleteManufacturer":
		isAuthorized("manageData");
		$status = Attribute::deleteManufacturer($_POST['id']);
		break;
	...
	case "addModel":
		isAuthorized("manageData");
		$status = Attribute::addModel($_POST);
		break;

	case "editModel":
		isAuthorized("manageData");
		$status = Attribute::editModel($_POST);
		break;

	case "deleteModel":
		isAuthorized("manageData");
		$status = Attribute::deleteModel($_POST['id']);
		break;
	...
	case "addSupplier":
		isAuthorized("manageData");
		$status = Attribute::addSupplier($_POST);
		break;

	case "editSupplier":
		isAuthorized("manageData");
		$status = Attribute::editSupplier($_POST);
		break;

	case "deleteSupplier":
		isAuthorized("manageData");
		$status = Attribute::deleteSupplier($_POST['id']);
		break;
	...
	case "addApiKey":
		...
		$status = ApiKey::add($_POST);
		break;

	case "editApiKey":
		isAuthorized("manageApiKeys");
		$status = ApiKey::edit($_POST);
		break;

	case "deleteApiKey":
		isAuthorized("manageApiKeys");
		$status = ApiKey::delete($_POST['id']);
		break;


	// custom fields
	case "addAssetCF":
		isAuthorized("addCustomField");
		$status = CustomField::addAssetCF($_POST);
		break;

	case "editAssetCF":
		isAuthorized("editCustomField");
		$status = CustomField::editAssetCF($_POST);
		break;

	case "deleteAssetCF":
		isAuthorized("deleteCustomField");
		$status = CustomField::deleteAssetCF($_POST['id']);
		break;


	case "addLicenseCF":
		isAuthorized("addCustomField");
		$status = CustomField::addLicenseCF($_POST);
		break;

	case "editLicenseCF":
		isAuthorized("editCustomField");
		$status = CustomField::editLicenseCF($_POST);
		break;

	case "deleteLicenseCF":
		isAuthorized("deleteCustomField");
		$status = CustomField::deleteLicenseCF($_POST['id']);
		break;
	...
	case "ticketsSettings":
		...
		if (isset($_POST['tickets_publicform']))
			$tickets_publicform = "true";
		else
	...
	// forum
	case "addTopic":
		isAuthorized("viewTickets"); // Use tickets auth as a proxy for staff access
		$forumParams = $_POST;
		$forumParams['peopleid'] = $liu['id']; // Inject current user ID
		if (isset($_FILES["file"]["name"][0]) && !empty($_FILES["file"]["name"][0])) {
			$forumParams['files'] = $_FILES;
		}
		$forum = new Forum();
		$status = $forum->addTopic($forumParams);
		break;

	case "addForumReply":
		isAuthorized("viewTickets");
		$forumParams = $_POST;
		$forumParams['peopleid'] = $liu['id'];
		if (isset($_FILES["file"]["name"][0]) && !empty($_FILES["file"]["name"][0])) {
			$forumParams['files'] = $_FILES;
		}
		$forum = new Forum();
		$status = $forum->addReply($forumParams);
		break;

	case "deleteTopic":
		isAuthorized("viewTickets");
		$forum = new Forum();
		// Quick check if the current user is admin or the owner
		$topic = $forum->getTopic($_POST['id']);
		if ($isAdmin || $topic['peopleid'] == $liu['id']) {
			$status = $forum->deleteTopic($_POST['id']);
		} else {
			$status = 11; // Error or Forbidden
		}
		break;
	...
	case "togglePinTopic":
		...
		$forum = new Forum();
		if ($isAdmin) {
			$status = $forum->togglePin($_POST['id'], $_POST['status']);
		} else {
			$status = 11;
		}
		break;

	case "toggleCloseTopic":
		isAuthorized("viewTickets");
		$forum = new Forum();
		if ($isAdmin) {
			$status = $forum->toggleClose($_POST['id'], $_POST['status']);
			if ($status == 20 || $status == 10) {
				$actionText = $_POST['status'] == 1 ? "closed" : "reopened";
				$icon = $_POST['status'] == 1 ? "🔒" : "🔓";
				$forumParams = array();
				$forumParams['topic_id'] = $_POST['id'];
				$forumParams['peopleid'] = $liu['id'];
				$forumParams['content'] = "System: Topic was " . $actionText . " by " . getSingleValue('people', 'name', $liu['id']);
				$forum->addReply($forumParams);
			}
		} else {
			$status = 11;
		}
