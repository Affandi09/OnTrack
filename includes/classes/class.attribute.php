...
class Attribute extends App
{
	...
	public static function addAssetCategory($data)
	{
		...
		if ($lastid == "0") {
			...
			logSystem("AssetCategory Added - ID: " . $lastid);
			return "10";
		}
	}
	...
	public static function editAssetCategory($data)
	{
		...
		$database->update("assetcategories", $updateData, ["id" => $data['id']]);
	...
	public static function addLicenseCategory($data)
	{
		...
		if ($lastid == "0") {
			...
			logSystem("LicenseCategory Added - ID: " . $lastid);
			return "10";
		}
	}
	...
	public static function addLabel($data)
	{
		...
		if ($lastid == "0") {
			...
			logSystem("Label Added - ID: " . $lastid);
			return "10";
		}
	}
	...
	public static function addManufacturer($data)
	{
		...
		if ($lastid == "0") {
			...
			logSystem("Manufacturer Added - ID: " . $lastid);
			return "10";
		}
	}
	...
	public static function addLocation($data)
	{
		...
		if ($lastid == "0") {
			...
			logSystem("Location Added - ID: " . $lastid);
			return "10";
		}
	}
	...
	public static function addModel($data)
	{
		...
		if ($lastid == "0") {
			...
			logSystem("Model Added - ID: " . $lastid);
			return "10";
		}
	}
	...
	public static function addSupplier($data)
	{
		...
		if ($lastid == "0") {
			...
			logSystem("Supplier Added - ID: " . $lastid);
			return "10";
		}
	}
	...
	public static function generateQrcodes($data)
	{
		...
		if ($lastid == "0") {
			...
			logSystem("QR Codes Generated - ID: " . $lastid);
			return "10";
		}
	}
	...
	public static function attachQrcode($data)
	{
		...
		if (!empty($qrcode)) {
			if ($database->has("assets", ["qrvalue" => $qrcode['value']]))
				return "11";
			elseif ($database->has("licenses", ["qrvalue" => $qrcode['value']]))
				return "11";
			else {
				if ($data['asset_id'] != 0) {
